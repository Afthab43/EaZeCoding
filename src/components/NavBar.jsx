...
const NavBar = () => {
  ...
  return (
    <div className="">
      <nav className="fixed top-0 z-50  backdrop-blur-lg border-b border-neutral-700/80 w-full ">
        <div className="container px-4 mx-auto relative text-sm ">
          <div className="flex  item-center justify-between h-full  ">
            ...
            <ul className="hidden lg:flex ml-14 space-x-12  items-center  ">
              {navItems.map((item, index) => {
                return (
                  <>
                    <li
                      className=" h-full py-5 text-white hover:text-purple-500  hover:border-purple-800 hover:border-b-[3.5px] duration-200"
                      key={index}
                    >
            ...
            <div className="lg:hidden md:flex flex flex-col  justify-end pb-6 ">
            ...
            {/* mobile view here */}
            {mobileDrawer && (
              <div className="fixed right-0 z-20 bg-neutral-50-200 w-full  flex flex-col justify-center  items-center lg:hidden mt-16  border-b border-neutral-700">
                <ul className="w-full  ">
                  {navItems.map((item, index) => {
                    return (
                      <li
                        className="flex justify-center p-3  bg-neutral-950 border-b border-neutral-900 "
                        key={index}
                      >
                        <a href={item.to}>{item.label}</a>
                      </li>
